...
export default function ListBiayaDUSB() {
  const rows = listBiayaDUSBDummy?.map((element) => (
    <Table.Tr key={element.id}>
      ...
      <Table.Td className="flex items-center justify-evenly gap-3">
        <ModalForm title="Tambah List Biaya DUSB" formType="list_biaya_dusb">
    ...
    <div className="flex flex-col gap-5">
      <Card className="flex justify-between items-center flex-wrap gap-y-3">
        <div className="flex items-center gap-2">
          <ButtonBack />
          <h1 className="font-bold text-lg">List Biaya DUSB</h1>
        </div>
        <div className="flex items-center gap-2">
