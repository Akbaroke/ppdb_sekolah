...
import { riwayatPembayaranDUSBDummy } from '../../../data/dummy';
import ModalConfirm from '../../../components/ModalConfirm';
import ButtonDelete from '../../../components/ButtonDelete';
import ModalForm from '../../../components/ModalForm';
import moment from 'moment';

export default function RiwayatPembayaranDUSB() {
  const rows = riwayatPembayaranDUSBDummy?.map((element) => (
    <Table.Tr key={element.id}>
      ...
      <Table.Td className="text-nowrap">{element.no_pendaftaran}</Table.Td>
  ...
  return (
    <div className="flex flex-col gap-5">
      <Card className="flex justify-between items-center flex-wrap gap-y-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-bold text-lg">
            Riwayat Pembayaran Daftar Ulang Siswa Baru
          </h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          <ModalForm
            title="Manual Input Riwayat Pembayaran DUSB"
            formType="manual_dusb">
      ...
      <Card>
        ...
        />
        {riwayatPembayaranDUSBDummy?.length > 0 ? (
