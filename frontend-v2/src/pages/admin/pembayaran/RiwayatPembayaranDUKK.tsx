...
import { riwayatPembayaranDUKKDummy } from '../../../data/dummy';
import ModalConfirm from '../../../components/ModalConfirm';
import ButtonDelete from '../../../components/ButtonDelete';
import ModalForm from '../../../components/ModalForm';
import moment from 'moment';

export default function RiwayatPembayaranDUKK() {
  const rows = riwayatPembayaranDUKKDummy?.map((element) => (
  ...
  return (
    <div className="flex flex-col gap-5">
      <Card className="flex justify-between items-center flex-wrap gap-y-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-bold text-lg">
            Riwayat Pembayaran Daftar Ulang Kenaikan Kelas
          </h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          <ModalForm
            title="Manual Input Riwayat Pembayaran DUKK"
            formType="manual_dukk">
      ...
      <Card>
        ...
        />
        {riwayatPembayaranDUKKDummy?.length > 0 ? (
